...
if(CMAKE_SYSTEM_NAME STREQUAL "Windows")
    set(CTGUI_OS_WINDOWS 1)
elseif(CMAKE_SYSTEM_NAME STREQUAL "Android")
    set(CTGUI_OS_ANDROID 1)
...
if(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
    set(CTGUI_COMPILER_MSVC 1)
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "AppleClang")
    set(CTGUI_COMPILER_APPLE_CLANG 1)
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
    if(CMAKE_CXX_COMPILER_FRONTEND_VARIANT STREQUAL "MSVC")
        set(CTGUI_COMPILER_CLANG_CL 1)
    else()
        set(CTGUI_COMPILER_LLVM_CLANG 1)
    endif()
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    set(CTGUI_COMPILER_GCC 1)

    # Check if this is the TDM-GCC version.
    # The CTGUI_COMPILER_GCC_TDM variable will contain a text if TDM and will be empty otherwise.
    execute_process(COMMAND "${CMAKE_CXX_COMPILER}" "--version" OUTPUT_VARIABLE GCC_COMPILER_VERSION)
    string(REGEX MATCHALL ".*(tdm[64]*-[1-9]).*" CTGUI_COMPILER_GCC_TDM "${GCC_COMPILER_VERSION}")
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "IntelLLVM")
    set(CTGUI_COMPILER_INTEL_ONEAPI 1)
else()
