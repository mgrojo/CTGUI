...
CTGUI_API tguiBool tguiFloatRect_contains(const tguiFloatRect* rect, float x, float y);
CTGUI_API tguiBool tguiIntRect_contains(const tguiIntRect* rect, int x, int y);
CTGUI_API tguiBool tguiUIntRect_contains(const tguiUIntRect* rect, unsigned int x, unsigned int y);
