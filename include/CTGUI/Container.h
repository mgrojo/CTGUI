...
CTGUI_API tguiWidget** tguiContainer_getWidgets(tguiWidget* container, size_t* count); // tguiWidget_free must be called on each element in the returned list
...
CTGUI_API tguiWidget* tguiContainer_getWidgetAtPosition(tguiWidget* container, float x, float y, tguiBool recursive);

CTGUI_API tguiBool tguiContainer_focusNextWidget(tguiWidget* container);
CTGUI_API tguiBool tguiContainer_focusPreviousWidget(tguiWidget* container);
