...
CTGUI_API size_t tguiListView_addItemRow(tguiWidget* widget, tguiUtf32* item, unsigned int itemLength);

CTGUI_API tguiBool tguiListView_changeItem(tguiWidget* widget, size_t index, tguiUtf32* item, unsigned int itemLength);
...
CTGUI_API tguiUtf32* tguiListView_getItemRow(const tguiWidget* widget, size_t index, size_t* count);
CTGUI_API tguiUtf32* tguiListView_getItems(const tguiWidget* widget, size_t* count);
...
CTGUI_API void tguiListView_setExpandLastColumn(tguiWidget* widget, tguiBool expand);
CTGUI_API tguiBool tguiListView_getExpandLastColumn(const tguiWidget* widget);
