...
CTGUI_API tguiUtf32* tguiComboBox_getItems(const tguiWidget* widget, size_t* count);
CTGUI_API tguiUtf32* tguiComboBox_getItemIds(const tguiWidget* widget, size_t* count);
