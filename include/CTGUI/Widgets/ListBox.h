...
CTGUI_API tguiBool tguiListBox_addItem(tguiWidget* widget, tguiUtf32 item, tguiUtf32 id);
...
CTGUI_API tguiUtf32* tguiListBox_getItems(const tguiWidget* widget, size_t* count);
CTGUI_API tguiUtf32* tguiListBox_getItemIds(const tguiWidget* widget, size_t* count);
