...
tguiBool tguiListBox_addItem(tguiWidget* widget, tguiUtf32 item, tguiUtf32 id)
{
...
tguiUtf32* tguiListBox_getItems(const tguiWidget* widget, size_t* count)
{
...
tguiUtf32* tguiListBox_getItemIds(const tguiWidget* widget, size_t* count)
{
    ...
    for (auto& id : cppIds)
        cIds.emplace_back(ctgui::fromCppStr(id));
