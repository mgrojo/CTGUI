...
float tguiText_getStaticLineWidth(tguiUtf32 text, const tguiFont* font, unsigned int characterSize, unsigned int textStyle)
{
    return tgui::Text::getLineWidth(ctgui::toCppStr(text), *font->This, characterSize, textStyle);
}
